-- Simple Admin User Linking (No ON CONFLICT)
...
/*
-- Check if the admin user is already linked
SELECT 
  'Check existing company_users' as step,
  cu.id,
  cu.role,
  cu.is_active,
  c.company_name_en
...
-- If no existing record, insert the admin user
