import{s as f}from"./index-CHcuUdej.js";const Q=["performance","performance_based","hybrid"],B=async(i,r,a,m=100,e)=>{var t,p;try{console.log("🔍 getAllVestingEvents called with:",{companyId:i,statusFilter:r,eventTypeFilter:a,limit:m,grantIds:e});const d=`
      *,
      employees (
        id,
        first_name_en,
