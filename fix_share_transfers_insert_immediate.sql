-- =====================================================
-- IMMEDIATE FIX: share_transfers INSERT Policy - Final Solution
-- =====================================================
-- Run this SQL directly in Supabase SQL Editor
-- This fixes the RLS issue where INSERT policy can't see company_users records
...
-- Step 3: Create a function that checks company_users access using SECURITY DEFINER
-- This bypasses RLS on company_users
...
-- Step 4: Drop all existing INSERT policies on share_transfers
...
-- Test company_user_access function
SELECT 
  'Company User Access Test' as test_name,
