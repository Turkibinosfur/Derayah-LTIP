-- Fix the vesting event generation function
...
BEGIN
  ...
  -- Set exercise details for ESOP plans
  v_requires_exercise := (v_plan.plan_type = 'ESOP');
  ...
  IF v_cliff_months > 0 AND v_cliff_shares > 0 THEN
    ...
    INSERT INTO vesting_events (
      ...
      exercise_price, total_exercise_cost, requires_exercise,
